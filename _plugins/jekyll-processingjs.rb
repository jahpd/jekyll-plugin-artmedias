module Jekyll
  ...
  class P5 < Liquid::Block
    ...
    def render(context)
      ...
      "<div class=\"example\" id=\"#{@_id}\">#{@_id}<pre><code class=\"language-javascript\">#{content}</code></pre></div>"
    end
  end
  ...
  class P5LoadScript < Liquid::Tag
    ...
    # https://github.com/processing/p5.js/wiki/Embedding-p5.js
    def render(context)
      "<link rel=\"stylesheet\" href=\"/assets/css/prism.css\" type=\"text/css\"/><script src=\"/assets/js/processing.min.js\"></script><script src=\"/assets/js/render.js\"></script>"
    end
  end
